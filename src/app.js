      ...
      if (req.status == 200) {
        if (req.responseText) {
          ...
          entries.sort(function(a, b) {
              if (a.waitTime.postedWaitMinutes !== undefined && b.waitTime.postedWaitMinutes !== undefined) {
                return (a.waitTime.postedWaitMinutes < b.waitTime.postedWaitMinutes ? 1 : a.waitTime.postedWaitMinutes > b.waitTime.postedWaitMinutes ? -1 : 0);
              } else if (a.waitTime.postedWaitMinutes !== undefined && b.waitTime.postedWaitMinutes == undefined) {
                return 1;
              } else {
                return -1;
              }            
